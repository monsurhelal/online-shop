                ...
                <div class="col-md-3">
                    <div class="card product-card">
                        <div class="product-image position-relative">
                            <a href="{{ route('shop.product',$featuredProduct->slug) }}" class="product-img">
                                {{-- <img class="card-img-top" src="{{ asset('uploads/product/large/'.$featuredProduct->product_images->first()->image) }}" alt=""> --}}
                        ...
                        <div class="card-body text-center mt-3">
                            <a class="h6 link" href="{{ route('shop.product',$featuredProduct->slug) }}">{{ $featuredProduct->title }}</a>
    ...
    <div class="container">
        ...
        <div class="row pb-3">
            ...
            <div class="col-md-3">
                <div class="card product-card">
                    <div class="product-image position-relative">
                        <a href="{{ route('shop.product',$latestProduct->slug) }}" class="product-img">
                            {{-- <img class="card-img-top" src="{{ asset('uploads/product/large/'.$featuredProduct->product_images->first()->image) }}" alt=""> --}}
                            @if (!empty($productImage->image))
                                <img  class="card-img-top" src="{{ asset('uploads/products/small/'.$productImage->image) }}">
                                @else
                    ...
                    <div class="card-body text-center mt-3">
                        <a class="h6 link" href="{{ route('shop.product',$latestProduct->slug) }}">{{ $latestProduct->title }}</a>
                        <div class="price mt-2">
